...
export default function CnssCotisations() {
  ...
  const baseUrl = "http://localhost:8000/api/cnss-cotisations";
  ...
  const columns = [
    ...
    },
    {
      ...
      Cell: ({ row }) => (
        <>
          {/*{permissions.find((p) => p.entity === "cnss_cotisation")?.can_update === 1 && (*/}
          <Tooltip
            title="modifier"
            componentsProps={{
              tooltip: {
          ...
          {/*)}*/}
          {/*{permissions.find((p) => p.entity === "cnss_cotisation")?.can_delete === 1 && (*/}
          {/*    <Tooltip*/}
          {/*        title="supprimer"*/}
          {/*        componentsProps={{*/}
          {/*          tooltip: {*/}
          ...
          {/*>*/}
          {/*  <Button*/}
          {/*      onClick={() => navigate(`/cnss-cotisations/${row.original.id}`)}*/}
          {/*      variant="text"*/}
          {/*      color="secondary"*/}
          {/*      size="large"*/}
          {/*      sx={{ ml: 1 }}*/}
    ...
    <Grid item xs={6}>
      <Card sx={{ height: "100%" }}>
        ...
        >
          ...
          {/*{permissions.find((p) => p.entity === "cnss_cotisation")?.can_create === 1 && (*/}
