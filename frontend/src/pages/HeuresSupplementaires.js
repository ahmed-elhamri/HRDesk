...
export default function HeuresSupplementaires() {
  ...
  const columns = [
    ...
    { Header: "Nombre", accessor: "nombre" },
    {
      ...
      Cell: ({ row }) => (
        <>
          {permissions.find((p) => p.entity === "heure_supplementaire")?.can_update === 1 && (
            <Tooltip
              title="modifier"
              componentsProps={{
                tooltip: {
          ...
          {permissions.find((p) => p.entity === "heure_supplementaire")?.can_delete === 1 && (
            <Tooltip
              title="supprimer"
              componentsProps={{
                tooltip: {
        ...
        <Grid item xs={12}>
          <Card>
            ...
            >
              ...
              {permissions.find((p) => p.entity === "heure_supplementaire")?.can_create === 1 && (
            ...
            <MDBox px={2} pt={2} gap={2} display="flex" justifyContent="flex-end">
              <TextField
                label="Rechercher"
                variant="outlined"
                size="small"
